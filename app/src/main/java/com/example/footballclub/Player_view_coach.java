...
public class Player_view_coach extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ListView lv1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response=(JsonResponse) Player_view_coach.this;
        String q = "/player_view_coach?lid="+sh.getString("log_id","");
        q=q.replace(" ","%20");
        JR.execute(q);
    }
    ...
    public void response(JSONObject jo) {
        try {
            ...
            if(method.equalsIgnoreCase("player_view_coach")){
...
//                    lv1.setAdapter(clist);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Player_view_coach.this);
