...
public class Player_view_nutri extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_view_nutri);
        ...
        JR.json_response=(JsonResponse) Player_view_nutri.this;
        String q = "/player_view_nutri?lid="+sh.getString("log_id","");
        q=q.replace(" ","%20");
        JR.execute(q);
    }
    ...
    public void response(JSONObject jo) {
        try {
            ...
            if(method.equalsIgnoreCase("player_view_nutri")){
...
//                    lv1.setAdapter(clist);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Player_view_nutri.this);
