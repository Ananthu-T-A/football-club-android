...
public class Coch_view_profile extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coch_view_profile);
        ...
        JR.json_response = (JsonResponse) Coch_view_profile.this;
        String q = "/coachviewprofile?lid=" + sh.getString("log_id", "");
        q = q.replace(" ", "%20");
        JR.execute(q);
    }
...
//                        value[i]="Team: "+name[i]+"\nAbout: "+about[i]+"\nCity: "+city[i]+"\nEmail: "+email[i];
                    ...
                    Cust_coach_profile clist = new Cust_coach_profile(this, name, email, phone, place, dob, pic);
