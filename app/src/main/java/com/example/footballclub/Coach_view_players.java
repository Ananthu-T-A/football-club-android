...
public class Coach_view_players extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {

    ListView lv1;
    String[] psysician,dob,place,phone,email,value,loginid;
    SharedPreferences sh;
    public static String number,lid,name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coach_view_players);
        ...
        JR.json_response=(JsonResponse) Coach_view_players.this;
        String q = "/coachviewplayer?lid="+sh.getString("log_id","");
        q=q.replace(" ","%20");
        JR.execute(q);
    }
    ...
    public void response(JSONObject jo) {
        try {
            ...
            if(method.equalsIgnoreCase("coachviewplayer")){
                ...
                if(status.equalsIgnoreCase("success")){
                    ...
                    for(int i = 0;i<ja1.length();i++)
                    {
                        ...
                        psysician[i]=ja1.getJSONObject(i).getString("coach");
...
//                    lv1.setAdapter(clist);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Coach_view_players.this);
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items[item].equals("Chat")) {
                    ...
                    startActivity(new Intent(getApplicationContext(), ChatHere2.class));
