...
public class Customchat2 extends ArrayAdapter<String>
{
	...
	public Customchat2(Activity context, String[] message, String[] sid, String[] date)
	{
		//constructor of this class to get the values from main_activity_class

		super(context, R.layout.customlist_chat2, message);
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		View listViewItem = inflater.inflate(R.layout.customlist_chat2, null, true);
