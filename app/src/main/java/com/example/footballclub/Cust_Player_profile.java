...
public class Cust_Player_profile extends ArrayAdapter<String>  {
	...
	private String[] phone;
	 ...
	 public Cust_Player_profile(Activity context, String[] name, String[] email, String[] phone, String[] place, String[] adhar, String[] dob, String[] images) {
	        //constructor of this class to get the values from main_activity_class

	        super(context, R.layout.cust_player_profile, images);
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        ...
	        View listViewItem = inflater.inflate(R.layout.cust_player_profile, null, true);
