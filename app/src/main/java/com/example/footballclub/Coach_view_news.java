...
public class Coach_view_news extends AppCompatActivity implements JsonResponse{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coach_view_news);
        ...
        JR.json_response=(JsonResponse) Coach_view_news.this;
