...
public class ChatHere2 extends Activity  implements JsonResponse
{
	EditText ed1;
	ImageView b1;
	String chat;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_chat_here2);
		...
		b1.setOnClickListener(new View.OnClickListener() 
		{
			public void onClick(View arg0)
			{
				...
				else
				{
			        ...
			        JR.json_response=(JsonResponse) ChatHere2.this;
